...
class HGU2023_Dataset(MonoDataset):
    """Superclass for different types of KITTI dataset loaders
    """
    def __init__(self, *args, **kwargs):
        super(HGU2023_Dataset, self).__init__(*args, **kwargs)
        ...
        self.K = np.array([
            ...
            [0, 0, 1, 0],
            [0, 0, 0, 1]], dtype=np.float32)
        self.K[0] /= 1270   # normalization process
        self.K[1] /= 720
    ...
    def get_image_path(self, folder, frame_index, side):
        ...
        f_str = "frames{}{}".format(frame_index, self.img_ext) # for ai-hub data
